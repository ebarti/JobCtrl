...
from jobhunter.domain.enrichment.services import ExtractionResult
from jobhunter.domain.enrichment.use_cases import (
    EnrichBatchUseCase,
    EnrichJobUseCase,
    TierExtractor,
)
...
from jobhunter.domain.ports.enrichment import DetailPageFetcherPort
