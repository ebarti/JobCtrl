...
from jobhunter.materials.activities import cover_letter_activity, render_pdf_activity, tailor_job_activity
from jobhunter.pipeline import preparation
...
async def test_preparation_workflow_resumes_at_cover_after_worker_restart(
    ...
    monkeypatch.setattr("jobhunter.scoring.activities._score_one_job", fake_score_job)
    monkeypatch.setattr("jobhunter.materials.activities._tailor_one_job", fake_tailor_job)
    monkeypatch.setattr("jobhunter.materials.activities._cover_one_job", fake_cover_letter)
