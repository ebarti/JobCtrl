...
The installer and ``jobhunter doctor`` both need to answer the same questions:
...
ANALYSIS_LEGS_ENV = "JOBHUNTER_ANALYSIS_LEGS"
CODEX_BIN_ENV = "JOBHUNTER_CODEX_BIN"
CLAUDE_BIN_ENV = "JOBHUNTER_CLAUDE_BIN"
