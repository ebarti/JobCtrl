...
from jobhunter.domain.contact.research import ContactCandidate, ContactResearchTask
from jobhunter.domain.contact.research_services import ContactResearchService, ResearchSourceSpec
from jobhunter.domain.contact.value_objects import ContactAttribute, ContactLink, ContactRole
from jobhunter.domain.identifiers import ContactId, generate_contact_id
from jobhunter.domain.ports.contact import (
    ContactRepository,
