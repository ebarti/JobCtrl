...
from jobhunter.domain.materials.claim_grounding import ground_claim_mappings
        ...
        *,
        ...
        messages = [
            LlmMessage(
                role="system",
                content=(
                    "Run the existing JobHunter adversarial review gate for "
...
def _judge_prompt(
    *,
    ...
    return f"""Review the generated interview prep as the existing JobHunter judge gate.
