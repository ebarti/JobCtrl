...
from jobhunter.domain.enrichment.aggregate import JobEnrichment
...
from jobhunter.domain.ports.enrichment import EnrichmentRepository
...
def _to_application_url(snapshot_apply_url: SnapshotApplyUrl):
    ...
    from jobhunter.domain.enrichment.value_objects import ApplicationUrl
