    ...
    def __init__(
        ...
        *,
        ...
        self._earliest_internal_ms = (
            ...
            else _int_env("JOBCTRL_GMAIL_AFTER_MS")
        )
        self._to_email = to_email if to_email is not None else os.environ.get("JOBCTRL_GMAIL_TO_EMAIL", "")
        ...
        try:
            if method == "initialize":
                result = {
                    ...
                    "capabilities": {"tools": {}},
                    "serverInfo": {"name": "jobctrl-gmail", "version": __version__},
                }
...
def _domains_from_env() -> tuple[str, ...]:
    raw = os.environ.get("JOBCTRL_GMAIL_ALLOWED_DOMAINS", "")
