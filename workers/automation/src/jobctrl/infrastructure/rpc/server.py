...
from jobctrl.infrastructure.rpc.workflow_starter import WorkflowStarter
from jobctrl.workflow_specs import workflow_result_to_dict
...
class JsonRpcServer:
    ...
    def dispatch(self, request: JsonRpcRequest) -> JsonRpcResponse | None:
        ...
        point.
        """
        tracer = trace.get_tracer("jobctrl.rpc")
