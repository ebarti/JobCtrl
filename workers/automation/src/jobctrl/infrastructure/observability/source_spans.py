...
def source_validation_span(
    *,
    ...
    scope_name: str = "jobctrl.discovery.sources",
) -> Iterator[None]:
...
def locator_span(
    *,
    ...
    scope_name: str = "jobctrl.discovery.locator",
) -> Iterator[None]:
    tracer = trace.get_tracer(scope_name)
...
def discovery_run_span(
    *,
    ...
    scope_name: str = "jobctrl.discovery.scheduler",
) -> Iterator[None]:
    tracer = trace.get_tracer(scope_name)
...
def source_quality_aggregation_span(
    *,
    ...
    event_count: int,
    span_count: int = 0,
    scope_name: str = "jobctrl.operations.source_quality",
) -> Iterator[None]:
    tracer = trace.get_tracer(scope_name)
