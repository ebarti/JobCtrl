...
``jobctrl.infrastructure.network`` (P1); the fetch surfaces route through it
...
PROJECT_REPOSITORY_URL = "https://github.com/ebarti/JobCtrl"
...
def _package_version() -> str:
    try:
        return importlib.metadata.version("jobctrl")
...
def default_honest_user_agent() -> HonestUserAgent:
    """The built-in honest UA: ``JobCtrl/<version> (+<repo url>)`` (D1)."""
