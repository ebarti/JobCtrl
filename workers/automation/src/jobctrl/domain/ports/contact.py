...
``jobctrl.infrastructure.contact.sqlite_repository.SqliteContactRepository``.
...
``jobctrl.infrastructure.contact.outreach_repository.SqliteOutreachThreadRepository``.
"""
...
class ResearchPageFetch:
    ...
    ``outcome`` is a :class:`~jobctrl.domain.contact.research.ResearchSourceOutcome`
