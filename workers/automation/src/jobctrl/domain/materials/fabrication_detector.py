...
from jobctrl.domain.materials.services import _build_allowed_skill_terms
from jobctrl.domain.materials.value_objects import ControlRule
...
def build_skill_vocabulary(profile: dict) -> frozenset[str]:
    ...
    (:func:`~jobctrl.domain.materials.services._build_allowed_skill_terms`) UNION
