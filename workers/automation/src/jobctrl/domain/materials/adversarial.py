...
from jobctrl.domain.scoring.value_objects import FitScore
from jobctrl.domain.materials.quality import TailoringPlan
...
def build_adversarial_review_prompt(
    *,
    ...
    return f"""You are running adversarial resume review for a high-fit JobCtrl opportunity.
