...
from jobctl.domain.pipeline.aggregate import OptimisticLockError
from jobctl.domain.pipeline.state_machine import is_valid_transition
from jobctl.domain.ports.events import EventPublisher
from jobctl.domain.tenant import LOCAL_TENANT
from jobctl.domain.pipeline_types import deserialize_stage_state_kind
...
def record_job_event(
    ...
    *,
    ...
    :func:`jobctl.infrastructure.events.get_default_publisher`.
