...
from jobctl.model_defaults import DEFAULT_GEMINI_MODEL
...
def read_spend_budget_status(*, daily_budget_usd: float | None = None) -> SpendBudgetStatus:
    ...
    if daily_budget_usd is None:
        from jobctl.infrastructure.scoring.criteria_provider import read_daily_budget_usd
