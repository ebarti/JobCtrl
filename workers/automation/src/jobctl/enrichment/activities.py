...
from jobctl.domain.errors import JobCtlError, TransientNetworkError, to_application_error
...
async def enrich_activity(payload: EnrichActivityInput) -> EnrichActivityOutput:
    ...
    from jobctl.pipeline.runner import _run_enrich, _run_stage_observed
...
def _run_selected_enrichment(
    ...
    *,
    ...
    from jobctl.enrichment.detail import _run_detail_scraper
