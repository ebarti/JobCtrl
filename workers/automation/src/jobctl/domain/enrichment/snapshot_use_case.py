...
from jobctl.domain.enrichment.value_objects import ExtractionTier
...
from jobctl.domain.ports.enrichment import EnrichmentRepository
...
def _to_application_url(snapshot_apply_url: SnapshotApplyUrl):
    ...
    from jobctl.domain.enrichment.value_objects import ApplicationUrl
