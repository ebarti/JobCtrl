...
from jobctl.domain.discovery.scheduler import DiscoveryRun
...
from jobctl.domain.job_content_identity import ContentMatchBasis
...
class JobBoardScraperPort(Protocol):
    ...
    ``jobctl.discovery.{jobspy,workday,smartextract}`` continue to
...
class JobRepository(Protocol):
    ...
    def list_recent(
        ...
        *,
        ...
        joining the ``jobctl_deleted_jobs`` tombstone table; passing
