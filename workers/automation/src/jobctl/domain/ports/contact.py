...
``jobctl.infrastructure.contact.sqlite_repository.SqliteContactRepository``.
...
``jobctl.infrastructure.contact.outreach_repository.SqliteOutreachThreadRepository``.
"""
...
from jobctl.domain.contact.outreach import OutreachThread
from jobctl.domain.contact.research import ContactResearchTask
...
class ResearchPageFetch:
    ...
    ``outcome`` is a :class:`~jobctl.domain.contact.research.ResearchSourceOutcome`
