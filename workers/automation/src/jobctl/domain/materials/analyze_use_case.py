...
from jobctl.domain.materials.analysis_eeo_screen import screen_eeo_red_flags
from jobctl.domain.materials.analysis_grounding import ground_and_snap
...
class AnalyzeJobUseCase:
    ...
    async def execute_async(
        ...
        *,
        ...
        from jobctl.domain.materials.analysis import cache_key as _cache_key
    ...
    def _resolve_prompts(self) -> tuple[str, str]:
        ...
        from jobctl.infrastructure.analysis.prompts import (
...
async def _default_ensemble_runner(*args, **kwargs) -> EnsembleOutcome:
    ...
    from jobctl.infrastructure.analysis.ensemble import run_ensemble
