...
if TYPE_CHECKING:  # pragma: no cover — type-only import, avoids any import cycle
    from jobctl.domain.materials.analyze_use_case import AnalyzeJobUseCase
    from jobctl.domain.ports.scoring import RequirementFitReportRepository
...
from jobctl.domain.materials.aggregate import (
    MaterialsLifecycle,
    MaterialsSet,
    MaterialsSetFactory,
)
...
from jobctl.domain.materials.coverage_audit import (
    KeywordCoverage,
    compute_keyword_coverage,
)
from jobctl.domain.materials.entities import Artifact
...
from jobctl.domain.materials.voice_metrics import measure_voice_delta
...
def _voice_system_prompt() -> str:
    ...
    """
    from jobctl.infrastructure.materials.voice_prompts import VOICE_SYSTEM_PROMPT
...
def _requirement_report_with_artifact_coverage(
    ...
    from jobctl.domain.scoring.value_objects import RequirementArtifactCoverage
...
def build_judge_prompt(
    ...
    *,
    ...
    return f"""You are the final resume quality judge for JobCtl.
