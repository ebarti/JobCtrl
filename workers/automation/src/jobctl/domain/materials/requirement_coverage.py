...
from jobctl.domain.materials.policy import RequirementLedTailoringControls

if TYPE_CHECKING:  # pragma: no cover - type-only without runtime import cycle
    from jobctl.domain.materials.claim_grounding import ClaimGrounding
...
def build_coverage_planner_prompt(
    *,
    ...
    return (
        "You are JobCtl's requirement-achievement coverage planner.\n"
