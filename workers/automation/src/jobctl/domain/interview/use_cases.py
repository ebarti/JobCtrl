...
from jobctl.domain.materials.claim_grounding import ground_claim_mappings
...
from jobctl.resume_profile import get_achievement_evidence
        ...
        *,
        ...
        messages = [
            LlmMessage(
                role="system",
                content=(
                    "Run the existing JobCtl adversarial review gate for "
...
def _judge_prompt(
    *,
    ...
    return f"""Review the generated interview prep as the existing JobCtl judge gate.
