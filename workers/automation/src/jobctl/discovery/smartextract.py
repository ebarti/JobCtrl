...
from jobctl.config import CONFIG_DIR
from jobctl.database import get_stats, init_db, resurface_deleted_job
from jobctl.domain.discovery.identity import DuplicateJobLink, JobSourceObservation
...
from jobctl.domain.discovery.source_registry import SMART_EXTRACT_EXPERIMENTAL_POLICY
from jobctl.domain.ports.discovery import ContentOwnerMatch
...
# ``jobctl.domain.extraction`` so the Enrichment context can import
# it without depending on this Discovery module. Imported here for the
# intra-module callers below.
from jobctl.domain.extraction import extract_json  # noqa: E402
