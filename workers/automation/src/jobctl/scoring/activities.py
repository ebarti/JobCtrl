...
async def score_activity(payload: ScoreActivityInput) -> ScoreActivityOutput:
    ...
    from jobctl.pipeline.runner import _run_score, _run_stage_observed
...
def _run_current_policy_scores(
    ...
    *,
    ...
    from jobctl.pipeline.current_policy_selectors import scoring_current_policy_job_urls
...
def _run_selected_scores(
    ...
    *,
    ...
    from jobctl.scoring.scorer import score_job_by_url
...
def _score_one_job(payload: ScoreJobActivityInput) -> dict[str, Any]:
    from jobctl.domain.errors import MissingInputError
    from jobctl.domain.tenant import TenantId
    from jobctl.scoring.scorer import score_job_by_url
