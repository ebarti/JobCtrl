...
from jobctl.infrastructure.apply.claude_code_cli import ClaudeCodeCliAdapter
from jobctl.infrastructure.apply.email_sender import GmailEmailApplicationSender
