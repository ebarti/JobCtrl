...
from jobctl.domain.ports.apply import AgentResult, BrowserSession
        ...
        *,
        ...
        try:
            ...
            if token_usage is not None:
                from jobctl.llm import record_llm_spend
...
def _kill_process_tree_if_alive(proc: subprocess.Popen) -> None:
    try:
        from jobctl.apply.chrome import _kill_process_tree
