...
from jobctl.domain.discovery.source_registry import RobotsPolicy, SourcePolicy
...
from jobctl.infrastructure.network.rate_limiter import get_shared_rate_limiter
...
UA_PRODUCT_ENV = "JOBCTL_CRAWL_UA_PRODUCT"
"""Env override for the honest-UA product token (default ``JobCtl``)."""

UA_CONTACT_ENV = "JOBCTL_CRAWL_UA_CONTACT"
...
def resolve_honest_user_agent() -> HonestUserAgent:
    ...
    Starts from :func:`default_honest_user_agent` (``JobCtl/<version>
