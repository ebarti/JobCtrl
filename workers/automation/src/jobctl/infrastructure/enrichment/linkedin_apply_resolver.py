...
from jobctl.infrastructure.network.proxy import ProxyConfig

log = logging.getLogger(__name__)

LINKEDIN_APPLY_RESOLVER_ENABLED_ENV = "JOBCTL_LINKEDIN_APPLY_RESOLVER"
LINKEDIN_APPLY_PROFILE_DIR_ENV = "JOBCTL_LINKEDIN_APPLY_PROFILE_DIR"
LINKEDIN_APPLY_SOURCE_PROFILE_DIR_ENV = "JOBCTL_LINKEDIN_APPLY_SOURCE_PROFILE_DIR"
LINKEDIN_APPLY_CHROME_PROFILE_ENV = "JOBCTL_LINKEDIN_APPLY_CHROME_PROFILE"
LINKEDIN_APPLY_HEADLESS_ENV = "JOBCTL_LINKEDIN_APPLY_HEADLESS"
LINKEDIN_APPLY_TIMEOUT_SECONDS_ENV = "JOBCTL_LINKEDIN_APPLY_TIMEOUT_SECONDS"
