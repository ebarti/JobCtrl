...
from jobctl.domain.profile.ports import PdfParserPort


class PyPdfProfileParser(PdfParserPort):
    """Adapter wrapping the package-internal resume PDF importer.

    The actual extraction lives in ``jobctl.profile_import`` because it
    ...
    def parse(
        ...
        *,
        ...
        # stub the port).
        from jobctl.profile_import import import_resume_pdf
