...
from jobctl.domain.profile.aggregate import DEFAULT_PROFILE_ID, InvalidProfileError, Profile
from jobctl.domain.profile.ports import PdfParserPort, ProfileImportResult
...
class SqliteProfileRepository:
    ...
    def load_snapshot(self, tenant_id: TenantId) -> ProfileSnapshot:
        ...
        if profile is None:
            raise FileNotFoundError("Profile not found in candidate_profiles. Run `jobctl init` first.")
        row = self._profile_row(tenant_id)
