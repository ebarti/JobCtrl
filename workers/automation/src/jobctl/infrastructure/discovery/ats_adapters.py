...
* ``WorkdayBoardAdapter`` — wraps the existing CXS JSON path used by
  ``jobctl.discovery.workday`` while moving the write boundary
...
from jobctl.infrastructure.discovery.location_filter import location_matches_target
from jobctl.discovery.title_filter import title_matches_query
from jobctl.infrastructure.observability.adapter_spans import adapter_fetch_span
...
:class:`~jobctl.infrastructure.network.http_client.GatewayHttpClient`
