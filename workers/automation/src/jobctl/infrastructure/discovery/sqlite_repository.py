...
Soft-delete state lives in the existing ``jobctl_deleted_jobs``
...
from jobctl.domain.discovery.aggregate import Job
from jobctl.domain.discovery.identity import (
    AtsKind,
...
class SqliteJobRepository:
    ...
    the ``jobctl_deleted_jobs`` tombstone table exists on
    ...
    def restore(
        ...
        *,
        ...
        # preserved.
        self._conn.execute(
            "UPDATE jobctl_deleted_jobs SET restored_at = ? "
            "WHERE job_url = ? "
