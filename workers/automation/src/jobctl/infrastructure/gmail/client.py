...
from jobctl.infrastructure.gmail.auth import GMAIL_SEND_SCOPE, GmailAuthError, get_access_token, load_token
...
def _ensure_send_scope() -> None:
    ...
    if GMAIL_SEND_SCOPE not in scopes:
        raise GmailAuthError("Gmail token missing gmail.send scope; run jobctl gmail-auth to re-consent")
