...
from jobctl.infrastructure.setup_probes import antigravity_auth_kwargs
...
_ANTIGRAVITY_SCOPE = "jobctl.analysis.antigravity"
...
_RUNTIME_DIR_NAME = "jobctl-antigravity"
