...
from jobctl.infrastructure.analysis.prompts import build_synthesizer_user_prompt
...
_DRAFT_SCOPE = "jobctl.analysis.claude"
_SYNTHESIZER_SCOPE = "jobctl.analysis.synthesizer"
