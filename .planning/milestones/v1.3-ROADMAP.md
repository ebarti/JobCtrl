...
- [x] **Phase 21: Jobs Triage UX & Warning-Only Floor** - Users can scan and inspect compensation evidence in Jobs triage without salary data becoming an automatic gate.
- [x] **Phase 22: Product-Path QA & Safety Release** - Users can rely on v1.3 compensation behavior being verified with synthetic/manual reported compensation data and no prohibited actions.
...
- [x] 21-01-PLAN.md — Projection-owned warning-only floor comparison contract

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 21-02-PLAN.md — Python projection parity for floor comparison

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 21-03-PLAN.md — Jobs list compensation scan columns

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 21-04-PLAN.md — Jobs drawer compensation audit section

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 21-05-PLAN.md — Product-path QA and reliability documentation
...
- [x] 22-01-PLAN.md — Release matrix and validation artifact completion

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 22-02-PLAN.md — Backend/API/projection release evidence gap closure
- [x] 22-03-PLAN.md — Frontend/Playwright visible-state and safety boundary closure

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 22-04-PLAN.md — Release gate, verification artifact, and QA status finalization
...
| 21. Jobs Triage UX & Warning-Only Floor | 5/5 | Complete   | 2026-06-21 |
| 22. Product-Path QA & Safety Release | 4/4 | Complete   | 2026-06-21 |
