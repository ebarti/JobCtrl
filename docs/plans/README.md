...
As of 2026-07-14, the bundled distribution, public live-demo, and end-to-end
product-redesign plans below are the active dated plans at the top level. The
distribution and demo implementation stacks have landed but retain open
publication/cutover definitions of done; the product redesign is proposed for
delivery. Earlier dated plans have landed or been closed with a recorded
outcome and live under `implemented/`. Add new accepted-but-not-yet-delivered
plans at the top level.
...
| 2026-07-14 | [End-to-End Product Redesign](2026-07-14-end-to-end-product-redesign.md) | Proposed — plan, data-parity contract, and delivery stack awaiting implementation |
...
| 2026-07-14 | [End-to-End Product Redesign](2026-07-14-end-to-end-product-redesign.md) | Proposed — implementation stack not yet delivered |
