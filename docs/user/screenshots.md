...
This is a screen-by-screen tour of JobCtrl, in the order you actually use it:
...
tailoring builds on. This is the single source of truth JobCtrl scores and
...
Next, tell JobCtrl what you are looking for. On the Discovery page you set your
