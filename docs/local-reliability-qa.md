...
shared `applyAudit` contract. When touching score visuals, sort by fit score
and verify score badges use the numeric color contract: 10 green, 5 gray,
and 0 red. Do not run apply submission, mailbox scanning,
