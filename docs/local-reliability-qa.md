...
Salary range, Market, and Warnings columns, that every data column can request a
sort, and that the drawer Compensation section separates posted salary from
