...
| Browser-layer dry-run enforcement fails to block hostile POST/PUT/PATCH/DELETE, form submission, WebSocket/beacon channels, or script/subresource GET/HEAD exfiltration, or live mode stops reaching the local fixture server | `workers/automation/tests/test_apply_chrome_dry_run_guard.py` |
