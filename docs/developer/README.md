...
| the Python worker | automation worker, JobCtrl worker | "the Python worker (a Temporal worker process that executes workflows)"; "Temporal worker" is reserved for that parenthetical |
