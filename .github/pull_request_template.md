...
- [ ] I ran the relevant local checks and listed them above. CI follows workflow events/path filters on individual PRs; external fork runs require maintainer approval.
