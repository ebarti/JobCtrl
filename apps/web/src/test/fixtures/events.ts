...
export const eventByType = {
  ...
  JobHidden: createJobHidden(LOCAL_TENANT, {
    jobId: JOB_ID,
    reason: "user-requested",
    hiddenAt: NOW,
  }),
  JobUnhidden: createJobUnhidden(LOCAL_TENANT, {
    jobId: JOB_ID,
    unhiddenAt: NOW,
  }),
  ...
  PipelineStepQueued: createPipelineStepQueued(LOCAL_TENANT, {
    execution: {
  ...
  PipelineStepStarted: createPipelineStepStarted(LOCAL_TENANT, {
    execution: {
      tenantId: LOCAL_TENANT,
      workflowId: "run-abc123",
      temporalRunId: "temporal-run-1",
  ...
  PipelineStepCompleted: createPipelineStepCompleted(LOCAL_TENANT, {
    execution: {
      tenantId: LOCAL_TENANT,
      workflowId: "run-abc123",
      temporalRunId: "temporal-run-1",
  ...
  PipelineStepFailed: createPipelineStepFailed(LOCAL_TENANT, {
    execution: {
      tenantId: LOCAL_TENANT,
      workflowId: "run-abc123",
      temporalRunId: "temporal-run-1",
  ...
  DryRunCompleted: createDryRunCompleted(LOCAL_TENANT, {
    jobId: JOB_ID,
    run_id: RUN_ID,
  ...
  ApplyReviewDecisionRecorded: createApplyReviewDecisionRecorded(LOCAL_TENANT, {
    jobKey: JOB_ID,
  ...
  ApplicationOutcomeRecorded: createApplicationOutcomeRecorded(LOCAL_TENANT, {
    jobKey: JOB_ID,
    outcomeId: "outcome-1",
    kind: "interview",
    source: "manual",
  ...
  OutcomeSuggestionDecided: createOutcomeSuggestionDecided(LOCAL_TENANT, {
    jobKey: JOB_ID,
    suggestionId: "suggestion-1",
    evidenceId: "evidence-1",
    decision: "accept",
  ...
  WorkflowCancellationRequested: createWorkflowCancellationRequested(LOCAL_TENANT, {
    workflowId: "run-abc123",
    workflowType: "JobPipelineWorkflow",
