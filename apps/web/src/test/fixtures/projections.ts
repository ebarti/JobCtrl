...
export const sampleCompensationAudit: JobCompensationAudit = {
  ...
  market: {
    ...
    estimate: {
      ...
      benchmarkLineage: {
        kind: "extrapolated",
        factId: "benchmark-extrapolated-es-platform-principal",
        ...
        freshUntil: "2026-06-27T08:00:00Z",
        directInputs: [
          {
            factId: "benchmark-direct-de-platform-principal",
            inputRole: "anchor",
            weight: 1,
            geography: {
              countryCode: "DE",
            ...
            minimumAmountEur: 100000,
            maximumAmountEur: 127000,
            confidenceScore: 0.82,
            sampleCount: 7,
            sourceId: "levels_fyi",
            sourceProvenance: "public",
            sourceSnapshotId: "levels-public-de-2026-06",
            asOfDate: "2026-06-01",
        ...
        priceLevelInputs: [
          {
            factId: "price-level-de-2026",
            inputRole: "source_price_level",
            weight: 1,
            countryCode: "DE",
            category: "actual_individual_consumption",
            referenceYear: 2026,
            baseGeographyCode: "EU27_2020",
            indexValue: 100,
            sourceId: "eurostat",
            sourceSnapshotId: "eurostat-pli-2026-06",
            asOfDate: "2026-06-01",
            fetchedAt: "2026-06-20T08:00:00Z",
            freshUntil: "2027-06-20T08:00:00Z",
          },
          {
            factId: "price-level-es-2026",
        ...
        anchorDirectFactId: "benchmark-direct-de-platform-principal",
        anchorGeography: {
          countryCode: "DE",
          subdivisionCode: null,
          locality: null,
        ...
        upperFactorBound: 10,
        factorBoundState: "within_bounds",
