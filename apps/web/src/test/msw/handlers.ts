...
const sampleCompensationSourcePolicy = {
  ...
  sources: [
    ...
    },
    {
      ...
      notes: ["Refresh automatically loads configured licensed rows from JOBCTRL_LEVELS_FYI_OBSERVATIONS_PATH or JOBCTRL_LEVELS_FYI_OBSERVATIONS_URL when access is permitted."],
    },
    {
      sourceId: "glassdoor",
