import type { LogOutreachSendRequest, OutreachThreadResponse } from "@jobhunter/contracts";
...
/**
 * Record a user-attested send of an approved draft (INV-1 — JobHunter never
