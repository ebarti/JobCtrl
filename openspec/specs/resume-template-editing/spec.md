## Purpose
Define the local resume-template editing capability for style-only template records, effective-template resolution, material snapshot metadata, and render-only lazy refresh.
