...
The system SHALL derive feedback signals from user replies to JobHunter comments. A reply signal MUST preserve whether the user accepted, rejected, clarified, or requested a rewrite of the comment while retaining the original comment and audit context.
