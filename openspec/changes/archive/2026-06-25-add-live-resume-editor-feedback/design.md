...
- Let the user reply to JobCtrl's line comments and preserve those replies as audit and learning data.
...
- How much comment UI should use Plate's comment plugin versus JobCtrl-owned thread components?
