...
remote-account credential. The browser extension's Phase 1 capture route is
limited to active-page capture after a user popup click; it queues captures only
in browser extension storage when the local stack is down and has no application
